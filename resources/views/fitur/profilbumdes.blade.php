<<<<<<< HEAD @extends('app') @section('css') <style>
        .rounded-circle {
        width: 280px;
        height: 280px;
        border-radius: 50%;
            ...
            <div class="container">
                                                    ...
                                                    <div class="modal-footer m-t-8">
                                                        <div class="mx-auto text-right">
                                                            ...
                                                            <button type="button" class="btn btn-primary"
                                                                data-toggle="modal" data-target="#foto">Edit
                                                                Foto/Gambar</button>
                                                        </div>
                                                    </div>
                                                </form>
                ...
                <div class="row">
                                            ...
                                            <div class="panel-body">
                                                <div class="row mt-2">
                                                    <button class="btn btn-primary mb-2 pb-2" style="margin-bottom: 25px"
                                                        data-toggle="modal" data-target="#tambahdatajasa"> Tambah Data Usaha
                                                    </button>
                                                                ...
                                                                @foreach ($usahajasa as $item)
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <div class="conbtn">
                                                                                <button
                                                                                    class="btn btn-primary center fa fa-edit"
                                                                                    data-toggle="modal"
                                                                                    data-target="#editjasa"
                                                                                ...
                                                                                <button
                                                                                    class="btn btn-success center fa fa-plus"
                                                                                    style="margin-left: 2%"
                                                                                    data-toggle="modal"
                                    ...
                                    <div class="tab-pane" id="profile1">
                                        ...
                                        <div class="tab-pane {{ $Tab == 'dagang' ? 'active' : '' }}" id="profile1">
                                            ...
                                            <div class="panel panel-primary">
                                                ...
                                                <div class="panel-body">
                                                    <div class="row mt-2">
                                                        <button class="btn btn-primary mb-2 pb-2"
                                                            style="margin-bottom: 25px" data-toggle="modal"
                                                            data-target="#tambahdatadagang"> Tambah Data Dagang </button>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form class="form-horizontal" role="form"
                                                            action="{{ route('usaha.store') }}" method="post">
                                                            @csrf
                                                            <input type="hidden" name="jenis" value="jasa">
                                                            {{-- lempar jenis --}}
                                                            <div class="form-group">
                                        ...
                                        <!-- sample modal content -->
                                        <div id="editjasa" class="modal fade" tabindex="-1" role="dialog"
                                            aria-labelledby="myModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    ...
                                                    <div class="modal-body">
                                                        <form class="form-horizontal" role="form" action=""
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <input name="nama" type="text"
                                                                        class="form-control" id="namajasa"
                                                                        placeholder="Nama Usaha atau Perusahaan" required>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <input name="lokasi" type="text"
                                                                        class="form-control" id="lokasijasa"
                                                                        placeholder="Alamat atau Lokasi Usaha" required />
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="modal-body">
                                                        <form class="form-horizontal" role="form" action=""
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <input name="nama" type="text"
                                                                        class="form-control" id="namadagang"
                                                                        placeholder="Nama Usaha atau Perusahaan" required>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <input name="lokasi" type="text"
                                                                        class="form-control" id="lokasidagang"
                                                                        placeholder="Alamat atau Lokasi Usaha" required />
                                                                </div>
                                                            </div>
                                        ...
                                        <div id="foto" class="modal fade" tabindex="-1" role="dialog"
                                            aria-labelledby="myModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                    ...
                    @endforeach --}}
                                        ...
                                        <div id="editjenis" class="modal fade" tabindex="-1" role="dialog"
                                            aria-labelledby="myModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    ...
                                                    <div class="modal-body">
                                                        {{-- @foreach ($jasa1 as $js) --}}
                                                        <form class="form-horizontal" role="form"
                                                            style="margin-left: 5px;" method="post" action="">
                                                            @csrf
